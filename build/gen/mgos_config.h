...
static inline int mgos_sys_config_get_gps_rx_gpio(void) { return mgos_config_get_gps_rx_gpio(&mgos_sys_config); }
void mgos_config_set_gps_rx_gpio(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_gps_rx_gpio(int v) { mgos_config_set_gps_rx_gpio(&mgos_sys_config, v); }
...
static inline int mgos_sys_config_get_gps_tx_gpio(void) { return mgos_config_get_gps_tx_gpio(&mgos_sys_config); }
void mgos_config_set_gps_tx_gpio(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_gps_tx_gpio(int v) { mgos_config_set_gps_tx_gpio(&mgos_sys_config, v); }
...
static inline int mgos_sys_config_get_app_update_interval(void) { return mgos_config_get_app_update_interval(&mgos_sys_config); }
void mgos_config_set_app_update_interval(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_update_interval(int v) { mgos_config_set_app_update_interval(&mgos_sys_config, v); }
